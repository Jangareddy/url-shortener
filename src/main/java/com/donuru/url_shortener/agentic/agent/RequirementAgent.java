...
public class RequirementAgent implements EngineeringAgent {
    ...
    public String execute(WorkflowContext context, WorkflowTask task) {
        ...
        ScenarioType scenario = (ScenarioType) context.getSharedContext().get("scenarioType");

        String requirement = (String) context.getSharedContext().get("requirement");
        ...
        context.putContext("requirementAnalysis", result);

        context.recordDecision("requirement-analysis", "Scenario analyzed: " + scenario);
