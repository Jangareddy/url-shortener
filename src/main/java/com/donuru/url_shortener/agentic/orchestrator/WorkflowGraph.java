...
public class WorkflowGraph {
    ...
    public WorkflowContext createDefaultWorkflow() {
        ...
        context.addTask(task(
                ...
                new HashSet<>(Set.of("requirements")),
                true
        ));
        ...
        context.addTask(task(
                ...
                new HashSet<>(Set.of("architecture")),
                false
        ));
        ...
        context.addTask(task(
                ...
                new HashSet<>(Set.of("implementation")),
                false
        ));
        ...
        context.addTask(task(
                ...
                new HashSet<>(Set.of("testing", "review")),
                false
        ));
        ...
        context.addTask(task(
                ...
                new HashSet<>(Set.of("documentation")),
                true
        ));
